...
const Cart = ({ cart, handleUpdateCartQty, handleRemoveFromCart, handleEmptyCart }) => {
  ...
  const EmptyCart = () => (
    <Typography variant="subtitle1">Vous n'avez pas d'objet, 
    <Link to="/" className={classes.link}> commencez à en ajouter</Link>
    </Typography>
  );
    ...
    <>
      ...
      <div className={classes.cardDetails}>
        ...
        <div>
          ...
          <Button component={Link} to ="/payer" className={classes.checkoutButton} size="large" type="button" variant="contained" color="primary">Payer</Button>
        </div>
      </div>
    </>
  );
